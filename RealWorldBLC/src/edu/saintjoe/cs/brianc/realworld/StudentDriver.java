...
public class StudentDriver {
	...
	public static void main(String[] args) {
		...
		Student nextStudent = new Student("Jared Alt", "M", "CMP", 1, 19);
		cmp112.setStudent(nextStudent, studentCount++);
		// cmp112.students[studentCount++] = nextStudent;
		nextStudent = new Student("Jude Brace", "M", "CMP", 2, 20);
		// cmp112.students[studentCount++] = nextStudent;
		cmp112.setStudent(nextStudent, studentCount++);
		nextStudent = new Student("Zach Bobos", "M", "CMP", 1, 19);
		// cmp112.students[studentCount++] = nextStudent;
		cmp112.setStudent(nextStudent, studentCount++);
		nextStudent = new Student("Ricardo Gutierrez", "M", "Accounting", 2, 20);
		cmp112.setStudent(nextStudent, studentCount++);
